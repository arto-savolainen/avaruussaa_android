...
// This activity displays app settings to the user. It is created from the Settings Views Activity template.
// Contains logic relating to input validation and the notification setting.
